...
namespace Zoom_API1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class instructorsDataTable : global::System.Data.TypedTableBase<instructorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public instructorsRow AddinstructorsRow(string name, string email, string status, string id) {
...
namespace Zoom_API1.DataSet1TableAdapters {
    ...
    public partial class instructorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [instructors] WHERE (([email] = @Original_email) AND ((@IsNull_status" +
                " = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ([id] = @Origin" +
                "al_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [instructors] ([email], [status], [id]) VALUES (@email, @status, @id)" +
                ";\r\nSELECT first_name + \' \' + last_name AS name, email, status, id FROM instructo" +
                "rs WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [instructors] SET [email] = @email, [status] = @status, [id] = @id WHERE (([email] = @Original_email) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ([id] = @Original_id));
SELECT first_name + ' ' + last_name AS name, email, status, id FROM instructors WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT first_name + \' \' + last_name AS name, email, status, id FROM instructors";
